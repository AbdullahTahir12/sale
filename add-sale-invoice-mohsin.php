								...
								<div class=" lb_top">
									...
									<div class=" col-lg-2 col-md-2  location_div">
										<div class="form-group">
											...
											<?php //echo 'SELECT * FROM item_location where FIND_IN_SET('.getCompanyId().',company_id) and FIND_IN_SET('.$user_row["head_id"].',id) order by id desc'; ?>
											<select class="transporter location_select proj_location chosen-select location_id" onchange="get_sub_location(this)" name="cr_location" id="location_id" required="true">
												<option selected>Select Location</option>
													<?php
													//$db->select('SELECT * FROM item_location where FIND_IN_SET('.getCompanyId().',company_id) and id IN('.$user_row["head_id"].') order by id desc');
										...
										<table class="table table-striped pq_table">
											<thead>
												<tr class="title_bg">
													...
													<th rowspan="2" class="border-b0">Rate</th>
											...
											<tr class="pq_row">
												...
												<td class="mat_modal">
													<div class="row">
														<div class="input-group">
															<span class="input-group-btn show_mt_modal ">
															...
															<!-- CARR MAT Modal -->
															<div class="<?php echo("modal fade carr_mat_modal").$sr_no ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
																			...
																			<div class="box box-danger">
																				<div class="box-body">
																					<div class="col-sm-6 col-xs-12">
																						...
																						<input type="number" class="form-control md_carriage inv_carriage" placeholder="Enter Carriage" name="inv_carriage[]" value="<?php echo $purchaseDetail['carriage'] ?>">
																					</div>
																					<div class="col-sm-6 col-xs-12">
																						<label> Material: </label>
																						<input type="number" class="form-control md_material inv_material" placeholder="Enter Materail" name="inv_material[]" value="<?php echo $purchaseDetail['material'] ?>">
																					</div>
																					<div class="clearfix"></div>
																					<div class="clearfix"></div>
																					<div class="carr-mat-button" style="margin:10px">
																						<button type="button" class="btn btn-primary pull-right" onclick="saveCarMAt('<?php echo ('carr_mat_modal').$sr_no ?>')">Save</button>
																					</div>
																				</div>
																			</div>
																		</div>
