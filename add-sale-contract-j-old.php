<?php	
	...
	if(isset($_POST['purchaseContract'])){
		...
		if(isset($_POST['contract_type']) && $_POST['contract_type'] == 'retail_sale' || isset($_POST['contract_type']) && $_POST['contract_type'] == 'distributer'){
...
<body class="skin-green-light sidebar-mini">
								...
								<div class="row" style="padding: 13px">
									<div class="col-sm-12">
										...
										<div class="col-md-6 no-gutter">
											<div class="col-md-6">
												...
												<select class="form-control chosen-select" onchange="get_sub_location(this)" name="location">
									...
									<div class="col-md-12">
										<div class="col-md-6 no-gutter">
											...
											<div class="col-md-6 customer <?php echo $s_contract['contract_type']; ?>" <?php if($s_contract['contract_type'] == 'whole_sale' || $s_contract['contract_type'] == 'company_sale'){?> style="display: none"<?php } ?>>
										...
										<div class="col-sm-3 " style="float:right">
											...
											<div class="col-md-12">
												...
												<div class="discount_with_vehicle col-md-6 no-gutter">
													...
													<label class="radio-inline"><input type="radio" value="yes" id="enable_dis" name="discount_mode" > Enable</label>
													<br>
													<label class="radio-inline"><input type="radio" name="discount_mode" id="disable_dis" value="no" checked> Disabled</label>
												</div>
									...
									<table class="table table-striped pq_table">
										<thead>
											<tr class="title_bg">
												...
												<th style="width:15%" class="hidden discount_heading border-b0">Discount</th>												
	...
	$('input[type=radio][name=discount_mode]').change(function(){
		...
		function ContractType(val_this){
			if($(val_this).val()=='retail_sale' || $(val_this).val()=='distributer'){
				$(".customer").show();
			}else{
				$(".customer").hide();
			}
