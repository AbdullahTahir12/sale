	...
	$obj_group = load_class('costcenter');
     ...
     if(isset($_REQUEST['command']) && $_REQUEST['command'] == 'selected_contract'){
     	if($_REQUEST['selected_type']=='distributer'){
			...
			// echo 'select * from ledger where	active_distributer="yes" and FIND_IN_SET("'.getCompanyId().'",company_id) and FIND_IN_SET("'.$_REQUEST["location_id"].'",distributer_head) and FIND_IN_SET("'.$_REQUEST["sublocation_id"].'",distributer_subhead)';
								...
								<div class="row" style="padding: 13px">
									<div class="col-sm-12">
										...
										<div class="col-md-6 no-gutter">
											...
											<div class="col-sm-2">
											<div>&nbsp;</div>
											<label style="margin-top: 15px"><input type="checkbox" class="subitem_mode" name="subitem_mode" value="yes"> Subitem </label>
										</div>
									...
									<div class="col-md-12">
										...
										<label style="margin-top: 15px">
											...
											<div class="col-md-4 customer <?php echo $s_contract['contract_type']; ?>" <?php if($s_contract['contract_type'] == 'whole_sale' || $s_contract['contract_type'] == 'company_sale'){?> style="display: none"<?php } ?>>
                                                ...
                                                <input type="hidden" value="<?php echo $contract['customer_id'] ?>" id="prev-select">
												<select class="form-control chosen-customer chosen-select" name="customer">
